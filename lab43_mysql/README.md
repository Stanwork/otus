...
* Выборка из бинарного лога на slave:

```
[root@slave vagrant]# mysqlbinlog /var/lib/mysql/mysql-bin.000003 | grep bookmaker
DROP TABLE IF EXISTS `bookmaker` /* generated by server */
...
/*!40000 ALTER TABLE `bookmaker` ENABLE KEYS */
  `bookmaker_competition` bigint(20) NOT NULL,
  ...
  `bookmaker_market` bigint(20) NOT NULL,
  KEY `bookmaker_market_id` (`bookmaker_market`),
  `bookmaker_outcome` bigint(20) NOT NULL,
